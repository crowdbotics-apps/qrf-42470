"""
Django settings for square_lake_42470 project.
...
ROOT_URLCONF = 'square_lake_42470.urls'
...
WSGI_APPLICATION = 'square_lake_42470.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_lake_42470 API",
    "DESCRIPTION": "API documentation for square_lake_42470 App",
    "VERSION": "v1",
}
